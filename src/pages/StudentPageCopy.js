...
// Firebase auth removed for offline demo
...
출처 : 유튜브 채널 느루`
  ...
  // Auth removed for offline demo

  const [showDiaryModal, setShowDiaryModal] = useState(false);

  // Auth removed for offline demo - direct access to student page
  if (!student) {
    return (
  ...
  return (
    <div style={{ 
      ...
      <div style={{ position: 'fixed', top: 24, right: 32, zIndex: 2000, display: 'flex', flexDirection: 'row', gap: 18, alignItems: 'center' }}>
        ...
        {/* 학습일지 버튼 */}
        <button onClick={() => window.open('https://script.google.com/macros/s/AKfycbxY2fE0kPXtjHCwhftlj2xnrxvxfFtBq3H-71Hz9-NtOIZR0U7aGvUy4iMR1a-o5hHK/exec', '_blank')} style={{ background: '#fffde7', border: 'none', borderRadius: 999, padding: '8px 18px', boxShadow: '0 2px 8px #b2ebf240', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 8 }}>
